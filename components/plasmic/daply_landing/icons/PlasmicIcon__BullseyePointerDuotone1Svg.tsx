...
export type BullseyePointerDuotone1SvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function BullseyePointerDuotone1SvgIcon(
  props: BullseyePointerDuotone1SvgIconProps
) {
  ...
  return (
    ...
    >
      ...
      <g clipPath={"url(#pTPJJi-Lo0lAa)"} fill={"#4162FF"}>
        <path
          opacity={".4"}
          d={
...
export default BullseyePointerDuotone1SvgIcon;
/* prettier-ignore-end */
