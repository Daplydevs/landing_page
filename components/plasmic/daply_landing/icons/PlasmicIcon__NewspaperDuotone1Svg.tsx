...
export type NewspaperDuotone1SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function NewspaperDuotone1SvgIcon(props: NewspaperDuotone1SvgIconProps) {
...
export default NewspaperDuotone1SvgIcon;
/* prettier-ignore-end */
