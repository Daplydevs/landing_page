...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: PXMFYnYwFhTS/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchIcon
              className={classNames(projectcss.all, sty.svg___1UbHu)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckIcon
              className={classNames(projectcss.all, sty.svg__yFx)}
              role={"img"}
            />
          ),
