...
// Get static paths (exported as a module.exports function for CommonJS)
const getStaticPaths = async () => {
    try {
        // Fetch pages dynamically from Plasmic or other CMS
        const pageModules = await fetchPagesFromCMS(); // Replace with your actual function to fetch pages
...
// Export getStaticPaths for Next.js (CommonJS syntax)
