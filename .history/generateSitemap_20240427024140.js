...
// Import function to fetch dynamic URLs from CMS
import { getDynamicUrls } from './utils/cms'; // Adjust the path as per your project structure
...
async function generateSitemap() {
  ...
  const dynamicUrls = await getDynamicUrls(); // Function to fetch dynamic URLs from CMS
