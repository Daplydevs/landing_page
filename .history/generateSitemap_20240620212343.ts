...
import { PlasmicComponent, PlasmicRootProvider, extractPlasmicQueryData, ComponentRenderData } from "@plasmicapp/loader-nextjs";
...
export const getStaticPaths: GetStaticPaths = async () => {
    ...
    const staticPaths = [
        ...
        { params: { catchall: [''] } }, // For the homepage
        { params: { catchall: ['co'] } }, // For the recent news articles page
    ];
